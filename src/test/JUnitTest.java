...
public class JUnitTest {
	...
	public void testCountLetters() {
		TextNote note = new TextNote("JavaUnitTest", "This lab is about JUnitTest");
		int num = note.countLetters();
		System.out.println(note.countLetters());
		assertEquals("The number of characters is not match", 35, num, 0.0);
	}
